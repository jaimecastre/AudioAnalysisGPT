...
public static class AgentPromptBuilder
{
    ...
    )
    {
        ...
        return $$"""
            ...
            - For report requests such as "generate report", "make a report", "QA report", "write an analysis report", or "create an investigation report": run ONLY generate_report on all selected files. The report tool runs the standard evidence suite internally and returns deterministic Markdown.
